...
def trade_batt2pv(sum_profit, sum_demand, index_buyer_pv, index_sellers_battery, count_buyers_pv, count_sellers_battery, deltakere, E, param):
    ...
    count_sellers_battery = len(index_sellers_battery)
    count_buyers_pv = len(index_buyer_pv)
    
    if (count_sellers_battery != 0):
        
        
        init_trans = (sum_demand/count_sellers_battery)*0.25
        for i in index_sellers_battery:
