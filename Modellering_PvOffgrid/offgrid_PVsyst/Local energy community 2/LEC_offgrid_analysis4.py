...
import offgrid_plot as off_plot
...
deltakere = [2, 4, 1, 1] #Kategorihytte på deltakerene 
bruksmønster = [1, 0, 1, 1] #Bruksmønster på deltakerene
...
off_plot.offgrid_plot(K[3], demand[3], pv[3], 18)
...
print('Bortkastet solenergi for hytte 4: {:.5g} kWh'.format(sum(K[3]['lost_production'])*0.25))
print()
...
print('Estimert forbruk som ikke blir dekt for hytte 1: {:.5g} kWh'.format(sum(K[2]['lost_load'])*0.25))
print('Estimert forbruk som ikke blir dekt for hytte 2: {:.5g} kWh'.format(sum(K[3]['lost_load'])*0.25))
...
print('Bortkastet solenergi for hytte 4: {:.5g} kWh'.format(sum_lost_production[3]*0.25))
print()
...
print('Estimert forbruk som ikke blir dekt for hytte 4: {:.5g} kWh'.format(sum_lost_load[3]*0.25))

b = (sum_lost_production[0]+sum_lost_production[1]+sum_lost_production[2]+sum_lost_production[3])*0.25
y = (sum_lost_load[0]+sum_lost_load[1]+sum_lost_load[2]+sum_lost_load[3])*0.25
...
#ofg_plot.LEC_offgrid_plot(dict_list, demand[1], pv[1], 1, 1)
