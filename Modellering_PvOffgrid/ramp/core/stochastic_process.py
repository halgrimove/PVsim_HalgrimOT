...
def Stochastic_Process(j):
    ...
    '''
    Funksjon som lager en daglig lastflytprofil. TAr inn last-input-filer
    '''
    
    Profile, num_profiles = Initialise_model()
    
    '''
    Stochastic_Process inneholder så mange daglige lastprofiler som brukeren skriver inn i initialise_model()
    '''
